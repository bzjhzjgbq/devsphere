...
const draftKey = "darksec-article-draft";
...
export default function PublishArticleForm() {
  ...
  const suggestedTags = useMemo(() => articleTags.slice(0, 8), []);
  ...
  function handlePublish(event) {
    ...
    const article = {
      ...
      readTime: "约 5 分钟",
      tag: normalizedTags[0] || "社区投稿",
      tags: normalizedTags.length ? normalizedTags : ["社区投稿"],
    ...
    localStorage.setItem(articlesKey, JSON.stringify([article, ...readStoredArticles()]));
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_300px]">
      <Card className="article-hero-surface px-6 py-6 sm:px-7">
      ...
      <div className="space-y-4 xl:sticky xl:top-24 xl:self-start">
        <Card className="article-side-surface p-5">
